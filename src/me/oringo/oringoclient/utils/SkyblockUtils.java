...
public class SkyblockUtils
{
    ...
    public void onPacketSent(final PacketSentEvent event) {
        if (event.packet instanceof C09PacketHeldItemChange) {
            SkyblockUtils.lastReportedSlot = ((C09PacketHeldItemChange)event.packet).func_149614_c();
        }
    }
    
    public static void updateItem() {
        if (SkyblockUtils.lastReportedSlot != SkyblockUtils.mc.field_71439_g.field_71071_by.field_70461_c) {
            SkyblockUtils.mc.func_147114_u().func_147298_b().func_179290_a((Packet)new C09PacketHeldItemChange(SkyblockUtils.mc.field_71439_g.field_71071_by.field_70461_c));
        }
    }
    
    public static void updateItemNoEvent() {
        if (SkyblockUtils.lastReportedSlot != SkyblockUtils.mc.field_71439_g.field_71071_by.field_70461_c) {
            PacketUtils.sendPacketNoEvent((Packet<?>)new C09PacketHeldItemChange(SkyblockUtils.mc.field_71439_g.field_71071_by.field_70461_c));
            SkyblockUtils.lastReportedSlot = SkyblockUtils.mc.field_71439_g.field_71071_by.field_70461_c;
        }
    }
    ...
    public void onTick(final TickEvent.ClientTickEvent event) {
        if (SkyblockUtils.mc.field_71441_e != null) {
    ...
    public static boolean isTeam(final EntityLivingBase e, final EntityLivingBase e2) {
        return e.func_145748_c_().func_150260_c().length() >= 4 && (e.func_145748_c_().func_150254_d().charAt(2) == '§' && e2.func_145748_c_().func_150254_d().charAt(2) == '§') && (SkyblockUtils.onSkyblock || e.func_145748_c_().func_150254_d().charAt(3) == e2.func_145748_c_().func_150254_d().charAt(3));
    }
    ...
    public static boolean hasLine(final String line) {
        try {
            ...
            for (final Score score : list) {
                ...
                String s;
                try {
                    s = ChatFormatting.stripFormatting(team.func_96668_e() + score.func_96653_e() + team.func_96663_f());
                }
                catch (Exception e) {
                    return false;
                }
                ...
                try {
                    s = ChatFormatting.stripFormatting(team.func_96668_e() + team.func_96663_f());
                }
                catch (Exception e2) {
                    return false;
                }
    ...
    public static boolean isNPC(final Entity entity) {
        ...
        return entity.func_110124_au().version() == 2 && entityLivingBase.func_110143_aJ() == 20.0f;
    }
