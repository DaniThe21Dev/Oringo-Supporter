        ...
        if (this.isToggled() && !(this.mc.field_71462_r instanceof GuiContainer) && !(this.mc.field_71462_r instanceof GuiEditSign) && this.pause < 1) {
            ...
            if (this.mc.field_71441_e != null) {
                ...
                if (this.mc.field_71476_x != null && this.mc.field_71476_x.field_72313_a == MovingObjectPosition.MovingObjectType.ENTITY) {
                    ...
                    if (entity2 instanceof EntityPlayer && !SkyblockUtils.isTeam((EntityLivingBase)entity2, (EntityLivingBase)this.mc.field_71439_g)) {
                        SkyblockUtils.click();
                        this.pause = 5;
                        return;
                    }
                }
                if (this.mc.field_71441_e.field_73010_i.stream().anyMatch(playerEntity -> !playerEntity.equals((Object)this.mc.field_71439_g) && playerEntity.func_70032_d((Entity)this.mc.field_71439_g) < 10.0f && SkyblockUtils.isTeam((EntityLivingBase)this.mc.field_71439_g, (EntityLivingBase)playerEntity) && (!playerEntity.func_82150_aj() || playerEntity.field_70163_u - this.mc.field_71439_g.field_70163_u <= 5.0))) {
                    ++this.ticksSeen;
                }
                else {
                    this.ticksSeen = 0;
