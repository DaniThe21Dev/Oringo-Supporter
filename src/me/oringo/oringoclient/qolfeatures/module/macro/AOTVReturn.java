...
public class AOTVReturn extends Module
{
    ...
    public void onTick(final TickEvent.ClientTickEvent event) {
        ...
        if (Mouse.isButtonDown(2) && OringoClient.mc.field_71462_r == null) {
            if (!this.wasDown && OringoClient.mc.field_71476_x != null && OringoClient.mc.field_71476_x.field_72313_a == MovingObjectPosition.MovingObjectType.BLOCK) {
                final BlockPos blockpos = OringoClient.mc.field_71476_x.func_178782_a();
                if (OringoClient.mc.field_71441_e.func_180495_p(blockpos).func_177230_c().func_149688_o() != Material.field_151579_a) {
