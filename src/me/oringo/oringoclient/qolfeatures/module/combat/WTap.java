...
public class WTap extends Module
{
    ...
    public void onPacket(final PacketSentEvent event) {
        if (this.isToggled() && ((event.packet instanceof C02PacketUseEntity && ((C02PacketUseEntity)event.packet).func_149565_c() == C02PacketUseEntity.Action.ATTACK) || (this.bow.isEnabled() && event.packet instanceof C07PacketPlayerDigging && ((C07PacketPlayerDigging)event.packet).func_180762_c() == C07PacketPlayerDigging.Action.RELEASE_USE_ITEM && OringoClient.mc.field_71439_g.func_70694_bm() != null && OringoClient.mc.field_71439_g.func_70694_bm().func_77973_b() instanceof ItemBow))) {
            ...
            switch (selected) {
                ...
                default: {
                    if (OringoClient.mc.field_71439_g.func_70051_ag()) {
                        OringoClient.mc.func_147114_u().func_147298_b().func_179290_a((Packet)new C0BPacketEntityAction((Entity)OringoClient.mc.field_71439_g, C0BPacketEntityAction.Action.STOP_SPRINTING));
                    }
                    OringoClient.mc.func_147114_u().func_147298_b().func_179290_a((Packet)new C0BPacketEntityAction((Entity)OringoClient.mc.field_71439_g, C0BPacketEntityAction.Action.START_SPRINTING));
                    break;
    ...
    public void onPacket(final PacketSentEvent.Post event) {
        if (this.isToggled() && ((event.packet instanceof C02PacketUseEntity && ((C02PacketUseEntity)event.packet).func_149565_c() == C02PacketUseEntity.Action.ATTACK) || (this.bow.isEnabled() && event.packet instanceof C07PacketPlayerDigging && ((C07PacketPlayerDigging)event.packet).func_180762_c() == C07PacketPlayerDigging.Action.RELEASE_USE_ITEM && OringoClient.mc.field_71439_g.func_70694_bm() != null && OringoClient.mc.field_71439_g.func_70694_bm().func_77973_b() instanceof ItemBow)) && !OringoClient.mc.field_71439_g.func_70051_ag()) {
            ((PlayerSPAccessor)OringoClient.mc.field_71439_g).setServerSprintState(false);
        }
    }
}
