...
public class AutoS1 extends Module
{
    ...
    public void onTick(final TickEvent.ClientTickEvent event) {
        if (OringoClient.mc.field_71439_g == null || !SkyblockUtils.inDungeon || !this.isToggled() || !SkyblockUtils.inP3) {
            return;
        }
        if (OringoClient.mc.field_71439_g.func_174824_e(0.0f).func_72438_d(new Vec3(309.0, 121.0, 290.0)) < 5.5 && !this.clicked && OringoClient.mc.field_71441_e.func_180495_p(new BlockPos(309, 121, 290)).func_177230_c() == Blocks.field_150430_aB) {
            this.clickBlock(new BlockPos(309, 121, 290));
            this.clicked = true;
            this.clickedButton = false;
        }
        if (AutoS1.clickPos != null && OringoClient.mc.field_71439_g.func_70011_f((double)AutoS1.clickPos.func_177958_n(), (double)(AutoS1.clickPos.func_177956_o() - OringoClient.mc.field_71439_g.func_70047_e()), (double)AutoS1.clickPos.func_177952_p()) < 5.5 && !this.clickedButton && OringoClient.mc.field_71441_e.func_180495_p(AutoS1.clickPos).func_177230_c() == Blocks.field_150430_aB) {
            for (int i = 0; i < 20; ++i) {
    ...
    private void clickBlock(final BlockPos hitPos) {
        ...
        OringoClient.mc.func_147114_u().func_147298_b().func_179290_a((Packet)new C08PacketPlayerBlockPlacement(hitPos, EnumFacing.func_176733_a((double)OringoClient.mc.field_71439_g.field_70177_z).func_176745_a(), OringoClient.mc.field_71439_g.field_71071_by.func_70448_g(), f, f2, f3));
    }
}
