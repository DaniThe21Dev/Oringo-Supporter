...
public class RemoveAnnoyingMobs extends Module
{
    ...
    public void onUpdate(final LivingEvent.LivingUpdateEvent event) {
        if (OringoClient.mc.field_71441_e == null || OringoClient.mc.field_71439_g == null) {
            return;
        }
        if (this.isToggled()) {
            ...
            if (event.entity instanceof EntityCreeper && event.entity.func_82150_aj() && ((EntityCreeper)event.entity).func_110143_aJ() == 20.0f) {
                OringoClient.mc.field_71441_e.func_72900_e(event.entity);
            }
            if (event.entity instanceof EntityCreeper && event.entity.func_82150_aj() && ((EntityCreeper)event.entity).func_110143_aJ() != 20.0f) {
    ...
    public void onWorldRender(final TickEvent.ClientTickEvent event) {
        ...
        if (!this.isToggled() || OringoClient.mc.field_71441_e == null) {
            return;
        }
        for (final Entity entity : OringoClient.mc.field_71441_e.func_72910_y()) {
            ...
            if (entity instanceof EntityFireworkRocket) {
                OringoClient.mc.field_71441_e.func_72900_e(entity);
            }
