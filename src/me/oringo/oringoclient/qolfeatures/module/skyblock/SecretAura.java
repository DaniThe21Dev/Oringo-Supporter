...
public class SecretAura extends Module
{
    ...
    public void onUpdatePre(final MotionUpdateEvent.Pre event) {
        if (OringoClient.mc.field_71439_g != null && this.isToggled() && SkyblockUtils.inDungeon && this.rotation.isEnabled()) {
            final Vec3i vec3i = new Vec3i(10, 10, 10);
            for (final BlockPos blockPos : BlockPos.func_177980_a(new BlockPos((Vec3i)OringoClient.mc.field_71439_g.func_180425_c()).func_177971_a(vec3i), new BlockPos((Vec3i)OringoClient.mc.field_71439_g.func_180425_c().func_177973_b(vec3i)))) {
                if (this.isValidBlock(blockPos) && OringoClient.mc.field_71439_g.func_70011_f((double)blockPos.func_177958_n(), (double)(blockPos.func_177956_o() - OringoClient.mc.field_71439_g.func_70047_e()), (double)blockPos.func_177952_p()) < this.reach.getValue()) {
                    final float[] floats = RotationUtils.getAngles(new Vec3(blockPos.func_177958_n() + 0.5, blockPos.func_177956_o() + 0.5, blockPos.func_177952_p() + 0.5));
    ...
    private boolean isValidBlock(final BlockPos blockPos) {
        final Block block = OringoClient.mc.field_71441_e.func_180495_p(blockPos).func_177230_c();
        if (block == Blocks.field_150465_bP) {
            final TileEntitySkull tileEntity = (TileEntitySkull)OringoClient.mc.field_71441_e.func_175625_s(blockPos);
    ...
    private void interactWithBlock(final BlockPos pos) {
        for (int i = 0; i < 9; ++i) {
            if (OringoClient.mc.field_71439_g.field_71071_by.func_70301_a(i) != null && OringoClient.mc.field_71439_g.field_71071_by.func_70301_a(i).func_82833_r().toLowerCase().contains(this.item.getValue().toLowerCase())) {
                ...
                if (OringoClient.mc.field_71441_e.func_180495_p(pos).func_177230_c() == Blocks.field_150442_at && !SecretAura.inBoss) {
                    OringoClient.mc.field_71442_b.func_178890_a(OringoClient.mc.field_71439_g, OringoClient.mc.field_71441_e, OringoClient.mc.field_71439_g.field_71071_by.func_70448_g(), pos, EnumFacing.func_176733_a((double)OringoClient.mc.field_71439_g.field_70177_z), new Vec3(0.0, 0.0, 0.0));
                }
                OringoClient.mc.field_71442_b.func_178890_a(OringoClient.mc.field_71439_g, OringoClient.mc.field_71441_e, OringoClient.mc.field_71439_g.field_71071_by.func_70448_g(), pos, EnumFacing.func_176733_a((double)OringoClient.mc.field_71439_g.field_70177_z), new Vec3(0.0, 0.0, 0.0));
    ...
    public void onPacket(final PacketReceivedEvent event) {
        if (event.packet instanceof S2DPacketOpenWindow && ChatFormatting.stripFormatting(((S2DPacketOpenWindow)event.packet).func_179840_c().func_150254_d()).equals("Chest") && SkyblockUtils.inDungeon && this.cancelChest.isEnabled()) {
            ...
            OringoClient.mc.func_147114_u().func_147298_b().func_179290_a((Packet)new C0DPacketCloseWindow(((S2DPacketOpenWindow)event.packet).func_148901_c()));
        }
    }
