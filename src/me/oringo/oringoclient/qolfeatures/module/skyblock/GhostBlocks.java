...
public class GhostBlocks extends Module
{
    ...
    public void onKey(final TickEvent.ClientTickEvent event) {
        if (OringoClient.mc.field_71462_r != null || OringoClient.mc.field_71441_e == null || !this.isToggled()) {
            return;
        }
        if (this.cordGhostBlocks.isEnabled() && SecretAura.inBoss) {
            for (final int[] i : this.cords) {
                OringoClient.mc.field_71441_e.func_175698_g(new BlockPos(i[0], i[1], i[2]));
            }
        }
        if (this.isPressed() && ((this.mode.getSelected().equals("Slow") && !this.wasPressed) || this.mode.getSelected().equals("Fast"))) {
            final Vec3 vec3 = OringoClient.mc.field_71439_g.func_174824_e(0.0f);
            final Vec3 vec4 = OringoClient.mc.field_71439_g.func_70676_i(0.0f);
            ...
            final BlockPos obj = OringoClient.mc.field_71441_e.func_147447_a(vec3, vec5, true, false, true).func_178782_a();
            if (this.isValidBlock(obj)) {
                return;
            }
            OringoClient.mc.field_71441_e.func_175698_g(obj);
        }
