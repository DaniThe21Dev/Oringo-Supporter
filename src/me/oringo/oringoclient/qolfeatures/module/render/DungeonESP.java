...
public class DungeonESP extends Module
{
    ...
    public void onUpdate(final MotionUpdateEvent.Pre event) {
        if (OringoClient.mc.field_71439_g.field_70173_aa % 20 == 0 && SkyblockUtils.inDungeon) {
            this.starredMobs.clear();
            for (final Entity entity2 : (List)OringoClient.mc.field_71441_e.field_72996_f.stream().filter(entity -> entity instanceof EntityLivingBase).collect(Collectors.toList())) {
                ...
                if (entity2 instanceof EntityBat && !entity2.func_82150_aj() && this.bat.isEnabled()) {
                    ...
                    if (this.starred.isEnabled()) {
                        if (entity2 instanceof EntityEnderman && entity2.func_70005_c_().equals("Dinnerbone")) {
                            ...
                            final List<Entity> possibleMobs = (List<Entity>)OringoClient.mc.field_71441_e.func_72839_b(entity2, entity2.func_174813_aQ().func_72314_b(0.1, 3.0, 0.1));
    ...
    private void drawBowWarning() {
        ...
        OringoClient.mc.field_71439_g.field_71174_a.func_175099_a(p1);
        OringoClient.mc.field_71439_g.field_71174_a.func_175099_a(p2);
    }
