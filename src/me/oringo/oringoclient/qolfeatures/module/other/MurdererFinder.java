...
public class MurdererFinder extends Module
{
    ...
    public void onTick(final TickEvent.ClientTickEvent event) {
        if (!this.isToggled() || OringoClient.mc.field_71439_g == null || OringoClient.mc.field_71441_e == null) {
            return;
        }
        try {
            if (OringoClient.mc.field_71439_g.func_96123_co() != null) {
                final ScoreObjective objective = OringoClient.mc.field_71439_g.func_96123_co().func_96539_a(1);
                if (objective != null && ChatFormatting.stripFormatting(objective.func_96678_d()).equals("MURDER MYSTERY") && SkyblockUtils.hasLine("Innocents Left:")) {
                    this.inMurder = true;
                    for (final EntityPlayer player : OringoClient.mc.field_71441_e.field_73010_i) {
                        ...
                        if (!MurdererFinder.murderers.contains(player)) {
                            ...
                            if (!this.autoSay.isEnabled() || player == OringoClient.mc.field_71439_g) {
                                continue;
                            }
                            OringoClient.mc.field_71439_g.func_71165_d(String.format("%s is murderer!", ChatFormatting.stripFormatting(player.func_70005_c_())));
                        }
                    }
                    return;
                }
        ...
        if (this.inMurder) {
            for (final Entity entity : OringoClient.mc.field_71441_e.field_72996_f) {
                if (entity instanceof EntityPlayer) {
                    ...
                    if (entity == OringoClient.mc.field_71439_g) {
                        continue;
                    }
